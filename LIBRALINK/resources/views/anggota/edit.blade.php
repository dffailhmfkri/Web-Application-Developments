...
@section('content')
    <form action="/anggota/{{ $user->id }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card pb-5">
            ...
            <div class="form-group mx-4 my-2">
                <label for="nama" class="text-md text-primary font-weight-bold">Nomor Induk Kependudukan</label>
            ...
            <div class="form-group mx-4 my-2">
                <label for="nama" class="text-md text-primary font-weight-bold">Pekerjaan</label>
