            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }} ">
                        ...
                        <div class="row mb-3">
                            <label for="npm" class="col-md-4 col-form-label text-md-end text-dark">{{ __('NIK') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="prodi" class="col-md-4 col-form-label text-md-end text-dark">{{ __('Pekerjaan') }}</label>
